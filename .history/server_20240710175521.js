...
// Import route files
const createEventRouter = require("./routes/create_event_route");
const getAllEventsRouter = require("./routes/get_all_events_route");
const getEventByIdRouter = require("./routes/get_event_by_id_route");
const updateEventRouter = require("./routes/update_event_route");
const deleteEventRouter = require("./routes/delete_event_route");
